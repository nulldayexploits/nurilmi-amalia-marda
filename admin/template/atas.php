...
.judul-content{ color: #25308C; }
.garis-judul-content{ width:70px;border:5px solid #25308C; }
.w3-red{ background-color: #25308C!important; }
...
<nav class="w3-sidebar w3-red w3-collapse w3-top w3-large w3-padding" style="z-index:3;width:300px;font-weight:bold;" id="mySidebar"><br>
  ...
  <div class="w3-container">
    <h3 class="w3-padding-64"><b>Pencarian UU Cipta Kerja</b></h3>
  </div>
  <div class="w3-bar-block">
    ...
    <a href="view.php" onclick="w3_close()" class="w3-bar-item w3-button w3-hover-white">UU Cipta Kerja</a>
